...
execute()
{
  xrun $xrun_opts \
       ...
       -f run.f \
       -top glbl \
       +incdir+"$ref_dir/../../../../project_1.gen/sources_1/bd/embsys/ipshared/ec67/hdl" \
       +incdir+"$ref_dir/../../../../project_1.gen/sources_1/bd/embsys/ipshared/7698" \
       +incdir+"../../../../project_1.gen/sources_1/bd/embsys/ipshared/ec67/hdl" \
       +incdir+"../../../../project_1.srcs/sources_1/bd/embsys/ip/embsys_nexys4io_0_2/drivers/nexys4io_v1_0/src" \
       +incdir+"../../../../project_1.gen/sources_1/bd/embsys/ipshared/7698" \
       -input simulate.do
}
